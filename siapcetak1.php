...
session_start();
$_SESSION ['huruf']='S';
$_SESSION ['halaman']='siapcetak1.php';
$_SESSION ['loket']='3';
?>
...
?>
          <div class="b1">
            ...
            <div class=" card card-body umum">
              ...
              <a href="#" class="btn btn-primary" onclick="next()">Next <i class="fa fa-forward"></i></a>
              </div>
            </div>
          </div>
          <?php include "bunyi2.php"; ?>
        </div>
...
<table class="table">
  <thead>
    <tr>
      <th scope="col" class="highlight2">Tanggal</th>
    <th scope="col" class="highlight2">Waktu</th>
     <th scope="col" class="highlight2">Nomor Antrian</th>
     <th scope="col" class="highlight2">Loket</th>
     <th scope="col" class="highlight2">Status Panggil</th>
    </tr>
  </thead>
  <tbody id="table">
