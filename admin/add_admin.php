...
if( isset($_POST["register"]) ) {
	...
	if( registrasi($_POST) > 0 ) {
		echo "<script>
                ...
                document.location.href = 'admin/data_login.php';
			  </script>";
	} else {
                    ...
                    <div class="intro-y box p-5">
                        <div>
                          <br>
                            ...
                            <div>
                                <label for="video" class="form-label">Password</label>
                                <input type="password" class="form-control"  name="password">                         
                              </div>
                            <div>
                              <br>
                                <label for="text" class="form-label">Konfirmasi Password</label>
                                <input type="password" class="form-control" name="password2" id="text"></input>
                            </div>
                            <br>
                            <div>
                            <div class="mb-3">
