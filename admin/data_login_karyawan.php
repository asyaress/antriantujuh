...
<html lang="en" class="light">
    ...
    <body class="py-5">
            ...
            <div class="content">
                ...
                <!-- END: Top Bar -->
                            ...
                            <div class="intro-y flex items-center h-10">
                                ...
                                <a href="add_karyawan.php" class="btn btn-primary" role="button">Tambah Karyawan</a>
        ...
        $query = "SELECT * FROM tb_karyawan ORDER BY id_karyawan ASC LIMIT $limit_start, $limit";
        ...
        while ($baris = $res1->fetch_assoc()) {
            ...
            <tr>
                ...
                <td><?php echo $baris['status_karyawan']; ?></td>

                <td>    <a class="btn btn-danger" href="del_karyawan.php?id_karyawan=<?= $baris["id_karyawan"]; ?>" onclick="return confirm('yakin?');">Hapus</a></td>
                </tr>
