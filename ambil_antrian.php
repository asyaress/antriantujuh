...
$tampilkan = mysqli_query($conn, "SELECT * FROM tb_bpjs WHERE id_karyawan IS NULL ORDER BY id ASC LIMIT 1");
...
$edit = mysqli_query($conn, "UPDATE tb_bpjs SET loket='$loket', id_karyawan='$id_karyawan' WHERE nomor='$nomor'");
