...
// Cek apakah nomor antrian ada dalam session
if (isset($_SESSION['nomor'])) {
    $nomor = $_SESSION['nomor'];  // Ambil nomor antrian dari session
    echo "Nomor antrian Anda adalah: $nomor";
} else {
...
if ($jumlah == 0) {
    ...
    exit;  // Jika nomor kosong, hentikan proses
}
