<?php
session_name('sesidesain2');  // Nama sesi yang diinginkan
session_start();  // Memulai session
if ($data) {
    $nomor = $data['nomor']; // Ambil nomor antrian
    $_SESSION['nomor'] = $nomor; // Perbarui session nomor
    echo "<p>Nomor Antrian Anda: $nomor</p>";
...
?>
    ...
    <div id="audioplay">
        ...
        print "<audio id='audio4' src='nadav2/10.mp3' type='audio/mpeg' preload='auto' > </audio>";
            ...
            print "<audio id='audio4' src='nadav2/100.mp3' type='audio/mpeg' preload='auto' > </audio>";
            print "<audio id='audio5' src='nadav2/10.mp3' type='audio/mpeg' preload='auto' > </audio>";
            ...
            print "<audio id='audio12' src='nadav2/$nomorb.mp3' type='audio/mpeg' preload='auto' > </audio>";
        ...
        ?>
        <audio id="audio7" src="nadav2/siapcetak.mp3" type="audio/mpeg" preload="auto" > </audio>
    ...
    <script>
             function panggil(){
                ...
                setTimeout(function(){audio8.play();},15000);
      ...
      function next(){
        ...
        <?php
                $edit = mysqli_query($conn, "UPDATE tb_umum SET loket='$_SESSION[loket]', panggil='sudah' WHERE nomor='$nomor'");
                ?>
                window.location='siapcetak2.php'
      }
    </script>
